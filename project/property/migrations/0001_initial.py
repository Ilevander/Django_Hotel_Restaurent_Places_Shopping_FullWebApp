    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('propoerty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='property_immage', to='property.property')),
            ],
        ),
        migrations.CreateModel(
            name='PropertyBook',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_owners', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
